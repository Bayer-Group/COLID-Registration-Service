...
//        IList<HistoricResourceOverviewDTO> GetHistoricOverviewByPidUri(string pidUri, Uri historicNamedGraph);
...
//        /// <param name="historicNamedGraph">Named graph for historic resource</param>
//        /// <param name="resourceNamedGraph">Named graph for current resource</param>
//        /// <returns>a single historized resource</returns>
//        Resource GetHistoricResource(string pidUri, string id, IList<string> resourceTypes, Uri historicNamedGraph, Uri resourceNamedGraph);
...
//        /// <param name="resourceNamedGraph">Named graph for current resource</param>
//        /// <returns>a single historized resource</returns>
//        Resource GetHistoricResource(string id, IList<string> resourceTypes, Uri historicNamedGraph, Uri resourceNamedGraph);
...
//        /// <param name="historicNamedGraph">Named graph for historic resource</param>
//        void CreateHistoricResource(Resource exisingResource, IList<MetadataProperty> metadataProperties, Uri historicNamedGraph);
...
//        /// <param name="historicNamedGraph">Named graph for historic resource</param>
//        /// <param name="resourceNamedGraph">Named graph for current resource</param>
//        void CreateInboundLinksForHistoricResource(Resource newHistoricResource, Uri historicNamedGraph, Uri resourceNamedGraph);
...
//        /// <param name="historicNamedGraph">Named graph for historic resource</param>
//        /// <param name="resourceNamedGraph">Named graph for current resource</param>
//        void DeleteDraftResourceLinks(Uri pidUri, Uri historicNamedGraph, Uri resourceNamedGraph);
...
//        /// <param name="historicNamedGraph">Named graph for historic resource</param>
//        /// <param name="resourceNamedGraph">Named graph for current resource</param>
//        void DeleteHistoricResourceChain(Uri pidUri, Uri historicNamedGraph, Uri resourceNamedGraph);
//    }
//}
