...
namespace COLID.RegistrationService.Common.Constants
{
    public static class Validation
    {
        ...
        public static readonly IList<string> OverwriteProperties = new List<string> { RDF.Type, EnterpriseCore.PidUri, Resource.BaseUri, Resource.DateCreated, Resource.Author, Resource.HasLastReviewer };
