...
namespace COLID.RegistrationService.Tests.Unit.Services.Validation.Validators.Others
{
    ...
    public class TaxonomyValidatorTests
    {
        ...
        public TaxonomyValidatorTests()
        {
            ...
            taxonomyRepoMock.Setup(t => t.GetTaxonomies(Graph.Metadata.Constants.Resource.Type.MathematicalModelCategory, _metadataGraphs)).Returns(mathematicalTaxonomy);
            taxonomyRepoMock.Setup(t => t.GetTaxonomies(Graph.Metadata.Constants.Resource.Type.InformationClassification, _metadataGraphs)).Returns(informationClassificationTaxonomy);
            ...
            metadataServiceMock.Setup(mock => mock.GetMultiInstanceGraph(It.IsAny<string>())).Returns(_metadataGraphs);
