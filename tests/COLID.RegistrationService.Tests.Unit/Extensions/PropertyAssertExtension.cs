...
namespace COLID.RegistrationService.Tests.Unit.Extensions
{
    public static class PropertyAssertExtension
    {
            ...
            this IDictionary<string, List<dynamic>> properties)
        {
            ...
            containsActions.Add(Graph.Metadata.Constants.Resource.HasLaterVersion, properties.CheckHasLaterVersion);
        ...
        public static bool ContainsRdfsLabel(this IDictionary<string, List<dynamic>> property, string label)
        {
            return ContainsSingleValue(property, RDFS.Label, label);
        }

        public static bool ContainsRdfsComment(this IDictionary<string, List<dynamic>> property, string comment)
        {
            return ContainsSingleValue(property, RDFS.Comment, comment);
        }

        public static bool ContainsAttachmentFileSize(this IDictionary<string, List<dynamic>> property, string fileSize)
        {
            return ContainsSingleValue(property, AttachmentConstants.HasFileSize, fileSize);
        }

        public static bool ContainsAttachmentFileType(this IDictionary<string, List<dynamic>> property, string fileType)
        {
            return ContainsSingleValue(property, AttachmentConstants.HasFileType, fileType);
        }
        ...
        public static bool CheckHasLaterVersion(this IDictionary<string, List<dynamic>> property, string laterVersion)
        {
                return ContainsSingleValue(property, Graph.Metadata.Constants.Resource.HasLaterVersion, laterVersion);
        }
