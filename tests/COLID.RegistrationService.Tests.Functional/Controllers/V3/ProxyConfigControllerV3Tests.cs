...
{
    public class ProxyConfigControllerV3Tests : IClassFixture<FunctionTestsFixture>
    {
        private readonly HttpClient _client;
        private readonly FunctionTestsFixture _factory;
        private readonly ITestOutputHelper _output;
        private readonly string _apiPath = "api/v3/proxyConfig";

        public ProxyConfigControllerV3Tests(FunctionTestsFixture factory, ITestOutputHelper output)
        {
            _factory = factory;
        ...
        public async Task GetProxyConfig_Success()
        {
            ...
            _output.WriteLine("actualConfig   =" + configString);
